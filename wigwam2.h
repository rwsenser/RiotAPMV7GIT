// wigwam2.h
// 2020-10-10:  Move return multiplier setting to mission.h
//              via the WIGWAM_MULT_FACTOR macro 
// 2020-06-24 Merge Completed
// 
// wigmam2 is based on wigmam1.h and mugged for Trinket and APM 
// * 2020-02-25
// *  included to get rudder_driver()
// *  intended for Arduino use
// ** ported to Arduino
// *  change RC_CENTER to RC_STRAIGHT for easy inegration with RIOT III code
//
...
int rudder_driver(long time, int heading, int command) {
  ...
  // pre 2020-06-22b:   { 1000,  0.5,  
	...
	int ret = RC_STRAIGHT;
	// note that this code is time dependent and at times just skips... which means wait...
	...
	rd_parms.prev_rc_command = ret;         // but this one could change as code is enhanced
  ...
  // ((this just seems wrong, why not just change table???))
  // minor change 2020-20-10
  ret *= WIGWAM_MULT_FACTOR; // was 4;  // so 5 to 20...., 0 to 0, -5 to -20.....  
	return ret;
}
